...
static const yytype_int16 yyrline[] =
{
     ...
     154,   157,   160,   161,   164,   165,   168,   169,   173,   174,
     175,   176,   180,   181,   185,   186,   187,   188,   191,   192,
     193,   194,   195,   198,   199,   200,   203,   206,   207,   208,
     209,   210,   211,   212,   213,   216,   217,   218,   219,   220,
     223,   224,   225,   228,   229,   230,   233,   234,   235,   238,
     239,   240,   243,   244,   245,   246,   247,   248,   251,   252,
     253,   256,   257,   260,   261,   262,   265,   266,   267,   270,
     271,   272,   275,   276,   277,   280,   283,   287,   288,   291,
     292,   297,   298,   299,   300,   303,   304,   307,   308,   311,
     312,   313,   316,   317,   318,   319
};
#endif
...
#line 43 "parser.y"
                        {if((yyvsp[-1].tree)!=NULL) (yyvsp[-1].tree)-> addSibling((yyvsp[0].tree)); /*$1->BGlobal(true);*/ (yyval.tree) = (yyvsp[-1].tree);}
...
#line 1755 "parser.tab.c"
  ...
  case 5: /* decl: varDecl  */
#line 47 "parser.y"
                   {(yyval.tree)=(yyvsp[0].tree); (yyvsp[0].tree)->BGlobal(true);}
...
#line 52 "parser.y"
                                     {if((yyvsp[-1].tree) != NULL){(yyvsp[-1].tree)->EType((yyvsp[-2].type));  /*$2->BGlobal(true)*/;} (yyval.tree)=(yyvsp[-1].tree);}
...
#line 2007 "parser.tab.c"
  ...
  case 47: /* paramID: ID  */
#line 114 "parser.y"
                                               {(yyval.tree) = newDeclNode(ParamK, UndefinedType, (yyvsp[0].tokenData)); (yyval.tree)->SetSize(1); }
#line 2013 "parser.tab.c"
    break;

  case 48: /* paramID: ID LBRACK RBRACK  */
#line 115 "parser.y"
                                               {treeNode* node = newDeclNode(ParamK, UndefinedType, (yyvsp[-2].tokenData)); node->setArray(true); node->SetSize(1); (yyval.tree) = node;}
...
#line 316 "parser.y"
                                 {treeNode* node = newExpNode(constantK, (yyvsp[0].tokenData), NULL, NULL, NULL); node->EType(Integer); node->SetSize(1); (yyval.tree)=node; }
#line 2713 "parser.tab.c"
    break;

  case 163: /* constant: CHARCONST  */
#line 317 "parser.y"
                                 {treeNode* node = newExpNode(constantK, (yyvsp[0].tokenData), NULL, NULL, NULL); node->EType(Char); node->SetSize(1); (yyval.tree)=node; }
#line 2719 "parser.tab.c"
    break;

  case 164: /* constant: STRINGCONST  */
#line 318 "parser.y"
                                 {treeNode* node = newExpNode(constantK, (yyvsp[0].tokenData), NULL, NULL, NULL); node->EType(Char); node->setArray(true); node->SetSize(strlen((yyvsp[0].tokenData)->svalue)+1); (yyval.tree)=node; }
#line 2725 "parser.tab.c"
    break;

  case 165: /* constant: BOOLCONST  */
#line 319 "parser.y"
                                 {treeNode* node = newExpNode(constantK, (yyvsp[0].tokenData), NULL, NULL, NULL); node->EType(boolean); node->SetSize(1); (yyval.tree)=node; }
