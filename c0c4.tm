...
* End ID
51 : LDA 1,-2(1)    Ghost Frame become new active frame
...
* TOFF = -2
* CALL output
55 : ST 1,-2(1) FP in ghost frame for output
* TOFF =-3
* Loading Parms
* ID
* (ID) TOFF =-4
...
* End ID
58 : LDA 1,-2(1)    Ghost Frame become new active frame
...
* TOFF = -2
* CALL output
62 : ST 1,-2(1) FP in ghost frame for output
* TOFF =-3
* Loading Parms
* TOFF =-4
* Assing Op
...
* End ID
78 : LDA 1,-2(1)    Ghost Frame become new active frame
...
* TOFF = -2
* CALL output
82 : ST 1,-2(1) FP in ghost frame for output
* TOFF =-3
* Loading Parms
* ID
* (ID) TOFF =-4
...
* End ID
85 : LDA 1,-2(1)    Ghost Frame become new active frame
...
* TOFF = -2
* CALL output
89 : ST 1,-2(1) FP in ghost frame for output
* TOFF =-3
* Loading Parms
* ID
* (ID) TOFF =-4
...
* End ID
92 : LDA 1,-2(1)    Ghost Frame become new active frame
...
* TOFF = -2
* CALL output
96 : ST 1,-2(1) FP in ghost frame for output
* TOFF =-3
* Loading Parms
97 : LDA 1,-2(1)    Ghost Frame become new active frame
...
105 : LDA 1,-3(0)  set frist frame (end of globals) 
